...
export default async function AgentePage() {
  ...
  // Avvisi salute OneDrive: arrivano con il TICK orario (agente_config), non coi soli
  // giri — il banner è fresco entro ~1h e si spegne al primo tick pulito.
  const avvisiSync = normalizzaAvvisiSync(config.avvisi_sync);
  ...
  return (
    <AgenteClient
      ...
      avvisiSyncIl={config.avvisi_sync_il ?? null}
    />
  );
}
