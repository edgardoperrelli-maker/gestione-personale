...
export async function GET(req: Request) {
  ...
  let q = supabaseAdmin
    ...
    .select('id, rapportino_id, voce_id, parent_voce_id, intervento_id, staff_id, staff_name, committente, data, stato, corsia, dati_operatore, dati_correnti, note, motivo_rifiuto, created_at, preso_in_carico_da, preso_in_carico_at, deciso_da, deciso_at, assegnato_committente_at')
