 ...
 * prima i file master caricati a mano (SOLO attivi: lo "spegnimento" è il toggle admin),
 * poi lo snapshot del master DUNNING/ZAGAROLO che l'agente invia a ogni giro.
