...
export default function TrasfertaAlert() {
  ...
  return (
    <div className="space-y-3 rounded-2xl border border-[var(--warning-soft)] bg-[var(--warning-soft)] p-4">
      <div className="flex items-start gap-3">
        <span className="mt-0.5 text-xl text-[var(--warning)]">!</span>
        <div className="flex-1">
          ...
          <div className="mt-2 space-y-2">
            {alerts.map((alert) => (
              <div key={alert.territory_id} className="rounded-xl border border-[var(--brand-border)] bg-[var(--brand-surface)] px-3 py-2">
                <div className="text-xs font-semibold uppercase tracking-wide text-[var(--warning)]">{alert.territory_name}</div>
