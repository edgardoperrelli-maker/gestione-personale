...
import type { PianoCard } from '@/utils/rapportini/groupByDayPiano';
...
export default function CardPianificazione({
  piano, dataLabel, copiedToken, onCopia, onRiapriHref, onEliminaPiano, onRimuoviOp,
      ...
      <div className="flex items-center justify-between gap-2 border-b border-[var(--brand-border)] px-3 py-2">
        ...
        <span className="flex items-center gap-2 text-[11px]">
          ...
          <MenuSposta
            modo="piano"
            territori={territori}
            territorioCorrente={piano.territorio}
