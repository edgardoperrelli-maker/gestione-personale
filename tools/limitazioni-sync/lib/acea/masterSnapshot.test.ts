...
describe('mappaMasterSnapshot', () => {
  it('mappa le righe grezze del master a snapshot {odl, attivita, ...} scartando gli ODL vuoti', () => {
    const grezze = [
      { odl: ' 912212680 ', attivita: '', esecutore: 'PASTORELLI', dataRaw: '2026-06-03 00:00:00', statoRaw: 'completato', matricola: 'M1', indirizzo: 'VIA ROMA 1', comune: 'ZAGAROLO', esito: 'eseguito', saracinesca: 'SI', odlSaracinesca: '999' },
    ...
    expect(out[1]).toEqual({ odl: 'A2', attivita: '', esecutore: '', dataRaw: '', statoRaw: '', matricola: '', indirizzo: '', comune: '', esito: '', saracinesca: '', odlSaracinesca: '' });
  });
